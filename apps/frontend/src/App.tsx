  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <div className="flex flex-1 flex-col overflow-hidden">
        <Header title=" AAAA" onMobileMenuClick={handleMobileMenuClick} />

        <main className="flex-1 overflow-auto p-4 sm:p-6 bg-muted/10  w-full max-w-[1200px] mx-auto">
          <div className="flex justify-between items-center mb-4 flex-wrap">
            ...
            >
              ...
              <p className="mt-4 text-xl max-w-sm mx-auto font-light text-gray-400 tracking-tight text-center">
                Create a group to start managing shared expenses with your
                people
              </p>
